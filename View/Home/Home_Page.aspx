<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Home_Page.aspx.vb" Inherits="track_web.Home_Page" %>
      ...
      <div class="row" dir="rtl">
        <div class="col-md-6">
          <div>
            ...
            <div>
              <asp:TextBox ID="TextBox2" runat="server" placeholder="ادخل كلمة المرور" ForeColor="Black" TextMode="Password" MaxLength="12"></asp:TextBox>
            </div>
            <div >
              <asp:Button ID="Button1" runat="server" Text="موافق" class="btn-primary"></asp:Button>
              <br>
